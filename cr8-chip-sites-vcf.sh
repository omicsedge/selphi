...
# dir="/home/nikita/work/selphi_fdraft/data/separated_datasets/chr20"

# chipsites_input="${dir}/reference_panel.30x.hg38_chr20_noinfo.chipsites-292-input-samples.vcf.gz"
# variants="${chipsites_input}.chip-variants.tsv"

# vcf_get_table "$chipsites_input" | cut -d$'\t' -f1-2,4-5 > "$variants"


# fullseq_refpan="${dir}/reference_panel.30x.hg38_chr20_noinfo.fullseq-2910-refpan-samples.vcf.gz"
# chipsites_refpan="${dir}/reference_panel.30x.hg38_chr20_noinfo.chipsites-2910-refpan-samples.vcf.gz"
